                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("1Eur Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 1Eur address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and 1eur: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 1Eur Core"), this);
    aboutAction->setStatusTip(tr("Show information about 1Eur Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 1Eur"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 1Eur addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 1Eur addresses"));
    ...
    openAction->setStatusTip(tr("Open a 1Eur: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 1Eur Core help message to get a list with possible 1Eur command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("1Eur Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 1Eur network", "", count));
}
...
{
    QString strTitle = tr("1Eur Core"); // default title
