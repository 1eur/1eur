...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("1Eur Core 1eur-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  1eur-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 1eur transaction") + "\n" +
                               "  1eur-tx [options] -create [commands]   " + _("Create hex-encoded 1eur transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded 1eur transaction
