...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* 1Eur features */
        {"1eur", "masternode", &masternode, true, true, false},
        {"1eur", "masternodelist", &masternodelist, true, true, false},
        {"1eur", "mnbudget", &mnbudget, true, true, false},
        {"1eur", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"1eur", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"1eur", "mnsync", &mnsync, true, true, false},
        {"1eur", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"1eur", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use 1eurd, or the -server option to 1eur-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> 1eur-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17320/\n";
}
