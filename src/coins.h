...
/** 
    ...
    ****Note - for 1Eur we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of 1eur coming in to a transaction
