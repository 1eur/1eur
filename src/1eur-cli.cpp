...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("1Eur Core RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  1eur-cli [options] <command> [params]  " + _("Send command to 1Eur Core") + "\n" +
                        "  1eur-cli [options] help                " + _("List commands") + "\n" +
                        "  1eur-cli [options] help <command>      " + _("Get help for a command") + "\n";
