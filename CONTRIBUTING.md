Contributing to 1Eur Core
============================

The 1Eur Core project operates an open contributor model where anyone is
...
The following applies to code changes to the 1Eur Core project, and is not to be
confused with overall 1Eur Network Protocol consensus changes.

Whether a pull request is merged into 1Eur Core rests with the project merge
...
Patches that change 1Eur consensus rules are considerably more involved than
...
Where a patch set proposes to change the 1Eur consensus, it must have been
...
The project leader is the release manager for each 1Eur Core release.
