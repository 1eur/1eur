1Eur Core version 2.2.1 is now available from:

  <https://github.com/lulworm/1eur/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/lulworm/1eur/issues>

Compatibility
==============

1Eur Core is extensively tested on multiple operating systems using
...
1Eur Core should also work on most other Unix-like systems but is not
...
of Bitcoin that 1Eur was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/1eur-project-translations/).
