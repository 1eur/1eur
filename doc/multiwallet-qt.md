...
In order to support loading of multiple wallets in 1eur-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is 1eur.cpp.
...
Changes to 1eur.cpp
----------------------
1eur.cpp is the entry point into 1eur-qt, and as such, will require some minor modifications to provide hooks for
