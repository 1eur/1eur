...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/1eur/1eur/blob/master/doc/translation_process.md#synchronising-translations).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/1eur/gitian.sigs.git
    git clone https://github.com/1eur/1eur-detached-sigs.git
...
- Detached signatures will then be committed to the [1eur-detached-sigs](https://github.com/1eur/1eur-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/1eur/1eur/releases/new) with a link to the archived release notes.
