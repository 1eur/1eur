...
1Eur now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<1eur_address\> \<monthly_payment_1eur\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ 1Eur, _12_ times over the course of a year totaling _24000_ 1Eur.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<1eur_address\> \<monthly_payment_1eur\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` 1Eur.
 ...
 * vote-many          - Vote on a 1Eur initiative
 * vote-alias         - Vote on a 1Eur initiative
 * vote               - Vote on a 1Eur initiative/budget
